        ...
        NavigationView {
            ...
            .alert(isPresented: $viewModel.isShowingImageUploadConfirmation, content: {
                ...
                return Alert(
                    ...
                    message: Text("The selected image will be uploaded with public viewing permissions, but it will not be shared. Do you want to save your message and upload the image?"),
